      ...
      <div class="space-y-8">
        ...
        <div class="pb-6 border-b border-gray-200 dark:border-gray-700">
          ...
          <p class="text-sm text-gray-600 dark:text-gray-400 mb-4 leading-relaxed">
            Configure the button's visual appearance and position. The button appears at the
            bottom-right corner of input elements.
          </p>
      ...
      <div class="space-y-8">
        ...
        <div class="pb-6">
          ...
          <p class="text-sm text-gray-600 dark:text-gray-400 mb-6 leading-relaxed">
            ...
            (e.g., 'example.com') or URL patterns (e.g., 'atlassian.net/jira') for more precise
            matching.
          </p>
